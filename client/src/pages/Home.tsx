  ...
  return (
    ...
    <div className="flex flex-col items-center justify-center">
      <main className="text-white m-auto grid grid-cols-4 grid-rows-8 gap-5 max-w-6xl overflow-hidden w-full h-full p-6 h-screen max-h-[800px]">
          ...
          {/* Main Header */}
          <div className="flex w-full h-full bg-neutral-800 border border-zinc-600 col-span-3 row-span-4 align-start justify-start p-6 rounded-lg hover:border-red-500 hover:border-1 transition duration-200"> 
